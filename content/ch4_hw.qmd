...
# Simultaneous prediction for new observations; Bonferroni procedure
ci.reg(m,data.frame(Lot.Size=c(30,55,80)),type="gn",alpha=al)

d.  Plot the residuals $e_{i}$ against $X_{i}$ to ascertain whether any departures from regression model (2.1) are evident. What is your conclusion?
